...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-body">
          <form action="/acts-store" method="POST">
            @csrf
            @method('PUT')   
            <div class="row">
              <div class="col">
                <div class="form-group">
                    <label>Title</label>
                    <input type="text" name="title" value=""class="form-control"><!-- {{old('title')}}    -->             
                  </div>
              </div>
              <div class="col">
                <div class="form-group">
                    <label>Title Text</label>
                    <input type="text" name="titletext" value=""class="form-control"> <!-- {{old('titletext')}} -->               
                  </div> 
              </div>
            </div>
            <div class="row">
             <div class="col"> 
               <div class="form-group">                  
                    <input type="date" name="date" value=""class="form-control" placeholder="enactmentdate"><!-- {{old('enactmentdate')}} -->                
               </div>
            </div>
          <div class="col">
