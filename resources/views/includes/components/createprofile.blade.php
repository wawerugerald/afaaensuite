  ...
  box-shadow: 0 4px 4px rgba(0, 0, 0, 0.4); ">
    ...
    box-shadow: 0 4px 4px rgba(0, 0, 0, 0.4);">
      ...
      <div class="form-group">
        ...
        <textarea id="editor" name="biography"class="form-control biography {{ $errors->has('biography') ? ' is-invalid' : ''}}" rows="20" value="{{ $user->biography }}" style="border-color: #17A61A; -moz-box-shadow: 0 4px 4px rgba(0, 0, 0, 0.4);
    -webkit-box-shadow: 0 4px 4px rgba(0, 0, 0, 0.4);
